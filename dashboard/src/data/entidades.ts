...
export const ENTIDADES: Record<EntidadeId, Entidade> = {
  ...
  camara: {
    ...
    orcamentoAnual: "R$ 35 milhões (estimado 2026)",
    ...
    vereadores: [
      ...
      { nome: "Bruno Leandro Coletor", partido: "PSDB" },
      ...
      { nome: "Marquinho da Cooperativa", partido: "MOBILIZA" },
      { nome: "Miguel da Saúde", partido: "PSD" },
      { nome: "Rogério Bueno", partido: "PV" },
