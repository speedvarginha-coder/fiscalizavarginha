...
window.ZELA.glossario = {
  ...
  "vigencia":          { simples: "Período",             explica: "Prazo em que o contrato está em vigor." },
  ...
  "situacao":          { simples: "Situação",            explica: "Status atual do contrato: ativo, encerrado, suspenso." },
};
