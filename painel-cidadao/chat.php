...
ATENÇÃO DIÁRIAS: O sistema Betha não registra o destino (cidade/motivo detalhado) nas diárias. Para saber para onde viajaram e o motivo específico, o cidadão deve fazer pedido LAI via [Modelos LAI](https://fiscalizavarginha.com.br/painel-cidadao/cobrar.html).
...
- Fornecedores/contratos Prefeitura: [Ver fornecedores](https://fiscalizavarginha.com.br/painel-cidadao/prefeitura.html)
- Obras públicas (Betha): [Ver obras no portal oficial](https://transparencia.betha.cloud/#/y7mn01LGqd_HCvGtj6VPwA==/consulta/83026)
- Câmara Municipal (gastos, contratos, vereadores): [Ver câmara](https://fiscalizavarginha.com.br/painel-cidadao/camara.html)
- Salários e servidores Prefeitura: [Ver salários](https://fiscalizavarginha.com.br/painel-cidadao/pessoal.html)
- Modelos de pedido LAI (21 modelos prontos): [Modelos LAI](https://fiscalizavarginha.com.br/painel-cidadao/cobrar.html)
- Painel principal: [Fiscaliza Varginha](https://fiscalizavarginha.com.br/painel-cidadao/)
...
- Matérias/emendas câmara (SAPL): [SAPL Câmara](http://sapl.varginha.mg.leg.br)
...
[Modelo LAI para fonte FUNDEB nas obras](https://fiscalizavarginha.com.br/painel-cidadao/cobrar.html)
